/*
 * DSA 2048 Arena — C++ Reference Implementation
 * ════════════════════════════════════════════════════════════════════
 * This file demonstrates the same data structures used in the web app,
 * implemented in C++ with full type safety and comments for academic use.
 *
 * Compile: g++ -std=c++17 -O2 -o dsa2048 main.cpp
 * Run:     ./dsa2048
 */
 ...
 *
 * Why:  The most recently played state must be undone first — LIFO.
 * Ops:  push O(1), pop O(1), top O(1)
 * ─────────────────────────────────────────────────────────────────── */
template <typename T>
class UndoStack
{
